...
<!--   <div class="row m-0">
  ...
  <div class="row m-0 full-height">
    <div class="col-3 p-0 ">
      <div class="subtitle">List of roles</div>
      <div class="add-role-wrap">
        <a href="" class="avis_submit" class="avis_submit">ADD A ROLE +</a>
      </div>
    ...
    <div class="col-9 full-height team-wrap">
      <div class="subtitle">
        <div class="tab_title active">Branches</div>
        <div class="tab_title ">Members</div>
      </div>
